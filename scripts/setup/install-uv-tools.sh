...
UV_TOOLS=(
    "claude-code-tools|tmux-cli:Terminal multiplexer CLI control,aichat:Claude Code session management,env-safe:Environment variable safety,gdoc2md:Google Docs to Markdown,md2gdoc:Markdown to Google Docs,vault:Secret management"
)
