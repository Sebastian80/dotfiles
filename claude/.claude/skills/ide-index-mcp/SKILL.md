...
questions go through `/ecom-phpstorm-index:index-lookup` (the ecom-phpstorm-index plugin). The write, refactoring and project-lifecycle sections below describe capabilities no agent
