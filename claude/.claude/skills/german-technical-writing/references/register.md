...
**Second person only in user-facing documentation aimed at a reader.** Use Sie-Form in product-facing documentation, Du-Form in internal wiki/team docs (PROJX team uses Du).

- ✅ *(PROJX team wiki)* "Achte darauf, dass der Branch auf `develop` basiert, bevor du merged."
...
- Sie-Form for customer-facing docs; Du-Form for internal team wiki (PROJX convention)
